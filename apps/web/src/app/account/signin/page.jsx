    ...
    <div className="flex min-h-screen w-full items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-50 p-4">
      ...
      >
        ...
        <a
          ...
          className="mb-6 inline-flex w-full items-center justify-center gap-2 rounded-lg border border-gray-200 bg-white px-4 py-3 text-base font-medium text-gray-700 hover:bg-gray-50"
        >
          <img
            src="https://ucarecdn.com/4b427541-a350-4678-9d4c-467403e7d203/-/format/auto/"
            alt="Google"
            className="h-5 w-5"
          />
